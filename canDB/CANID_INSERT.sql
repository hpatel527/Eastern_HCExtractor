...
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a1W',	'05C0003C', 'TENSION_a', 'U8_U8_U32','Tension_a: 1W Command code: [0] command code, [1]-[8] depends on code');
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a2W',	'05C0004C', 'TENSION_a', 'U8_U8_U32','Tension_a: 2W Command code: [0] command code, [1]-[8] depends on code');

INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a11',	'05C0000C', 'TENSION_a', 'U8_U8_U32','Tension_a11: Command code: [0] command code, [1]-[8] depends on code');
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a21',	'05E0000C', 'TENSION_a', 'U8_U8_U32','Tension_a21: Command code: [0] command code, [1]-[8] depends on code');
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a12',	'F800005C', 'TENSION_a', 'U8_U8_U32','Tension_a12: 2 AD7799 VE POD TESTING  3' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a22',	'F800006C', 'TENSION_a', 'U8_U8_U32','Tension_a22: 2 AD7799 VE POD TESTING  3' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_0',	'E8000000', 'TENSION_0', 'U8_U8_U32','Tension_0: Default command canid');
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a0X',	'F800001C', 'TENSION_a', 'U8_U8_U32','Tension_a:  1 AD7799 VE POD TESTING (hence 0) 0' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a1X',	'F800002C', 'TENSION_a', 'U8_U8_U32','Tension_a:  2 AD7799 VE POD TESTING (hence X) 1' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a2X',	'F800003C', 'TENSION_a', 'U8_U8_U32','Tension_a2: 2 AD7799 VE POD TESTING (hence X) 1' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a1Y',	'F800004C', 'TENSION_a', 'U8_U8_U32','Tension_a:  1 AD7799 VE POD TESTING (hence Y) 2' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a1G',	'F800007C', 'TENSION_a', 'U8_U8_U32','Tension_a:  2 AD7799 VE POD GSM 1st board sent (_16)' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_a2G',	'F800008C', 'TENSION_a', 'U8_U8_U32','Tension_a2: 2 AD7799 VE POD GSM 1st board sent (_16)' );
INSERT INTO CANID VALUES ('CANID_CMD_TENSION_2',	'05C0005C', 'TENSION_2', 'U8_U8_U32','Tension_2: Tension_2: Command code: [0] command code, [1]-[8] depends on code');

INSERT INTO CANID VALUES ('CANID_MOTOR_1',		'2D000000', 'MOTOR_1', 		'UNDEF','MOTOR_1: Motor speed');

INSERT INTO CANID VALUES ('CANID_CMD_CABLE_ANGLE_0',	'06000000', 'CABLE_ANGLE_0', 	'UNDEF','Cable_Angle0: Default measurement canid');
INSERT INTO CANID VALUES ('CANID_CMD_CABLE_ANGLE_1',	'06200000', 'CABLE_ANGLE_1', 	'UNDEF','Cable_Angle1: [0] command code, [1]-[8] depends on code');
...
INSERT INTO CANID VALUES ('CANID_CMD_ENGINE_SENSOR',	'80600000', 'ENGINE_SENSOR', 	'UNDEF','Engine: code: [0] command code, [1]-[8] depends on code');
...
INSERT INTO CANID VALUES ('CANID_CMD_GPS_1',		'D1C00044', 'GPS',	'UNDEF','GPS_1: CANID Command GPS 1');
INSERT INTO CANID VALUES ('CANID_CMD_GPS_2',		'D1C00074', 'GPS',	'UNDEF','GPS_2: CANID Command GPS 2');
INSERT INTO CANID VALUES ('CANID_CMD_LOGGER_1',		'D1C00054', 'LOGGER',	'UNDEF','Logger_1: Command Logger 1');
INSERT INTO CANID VALUES ('CANID_CMD_LOGGER_2',		'D1C00064', 'LOGGER',	'UNDEF','Logger_2: Command Logger 2');
...
INSERT INTO CANID VALUES ('CANID_SE2H_ERROR2',		'D0800004', 'SHAFT_LOWERSHV', 	'UNDEF','Shaft encoder: Lower sheave:SE2: error2');
INSERT INTO CANID VALUES ('CANID_CMD_LOWERSHV',		'D0800000', 'SHAFT_LOWERSHV', 	'UNDEF','Shaft encoder: Lower sheave:SE2: Command CAN: send commands to subsystem');
...
INSERT INTO CANID VALUES ('CANID_CMD_UPPERSHV',		'D0600000', 'SHAFT_UPPERSHV', 	'UNDEF','Shaft encoder: Upper sheave:SE3: Command CAN: send commands to subsystem');
...
INSERT INTO CANID VALUES ('CANID_CMD_DRIVE_SHAFT',	'D0400000', 'DRIVE_SHAFT', 	'UNDEF','Drive shaft: Command CAN: send commands to subsystem');
...
INSERT INTO CANID VALUES ('CANID_TILT_ALARM',		'02800000', 'TILT_SENSE', 	'UNDEF','Tilt: alarm: Vector angle exceeds limit');
...
INSERT INTO CANID VALUES ('CANID_CMD_TILT',		'42C00000', 'TILT_SENSE', 	'UNDEF','Tilt:Command CANID');
...
INSERT INTO CANID VALUES ('CANID_CMD_CANSENDER_1',	'A0200000', 'CANSENDER','UNDEF',	'Cansender_1:Command CANID');
INSERT INTO CANID VALUES ('CANID_CMD_CANSENDER_2',	'A0400000', 'CANSENDER','UNDEF',	'Cansender_2:Command CANID');
...
INSERT INTO CANID VALUES ('CANID_CMD_SANDBOX_1',	'28E00000', 'SANDBOX_1',	'UNDEF','HC: SANDBOX_1: Launch parameters');

INSERT INTO CANID VALUES ('CANID_CMD_YOGURT_1',		'29800000', 'YOGURT_1',		'UNDEF','Yogurt: YOGURT_1: Yogurt maker parameters');
...
INSERT INTO CANID VALUES ('CANID_UNIT_19',		'0280000C', 'UNIT_19', 		'U8','Master Controller');
