...
const uint32_t paramval[] = {
 ...
 0xFFFFFFFC , /*  47 CANID_DUMMY         17  Tension_a11: 47 CANID 4 added to CAN hardware filter to allow incoming msg      */
...
const uint32_t paramval[] = {
 ...
 0xFFFFFFFC , /*  47 CANID_DUMMY         17  Tension_a12: 47 CANID 4 added to CAN hardware filter to allow incoming msg      */
...
const uint32_t paramval[] = {
 ...
 0xFFFFFFFC , /*  47 CANID_DUMMY         17  Tension_a21: 47 CANID 4 added to CAN hardware filter to allow incoming msg      */
...
const uint32_t paramval[] = {
 ...
 0xFFFFFFFC , /*  47 CANID_DUMMY         17  Tension_a22: 47 CANID 4 added to CAN hardware filter to allow incoming msg      */
...
const uint32_t paramval[] = {
 ...
 0x29800000 , /*  48 CANID_CMD_YOGURT_1  17  Yogurt_1: 48 CANID: cid_yog_cmd: Yogurt maker parameters                        */
...
#define CAN_UNIT_11_CMDID_TABLE_SIZE 1	// Tension_a2: 2 AD7799 VE POD Test (hence X) 1

#define CAN_UNIT_12_CMDID_TABLE_SIZE 2	// Yogurt_1: Ver 1 of maker

#define CAN_UNIT_13_CMDID_TABLE_SIZE 1	// Tension_a:  1 AD7799 VE POD Test (hence X) 2

#define CAN_UNIT_14_CMDID_TABLE_SIZE 1	// Tension_a2: 2 AD7799 VE POD Test (hence X) 3

#define CAN_UNIT_15_CMDID_TABLE_SIZE 2	// Tension_a2: 2 AD7799 VE POD GSM 1

#define CAN_UNIT_16_CMDID_TABLE_SIZE 2	// Logger_2

#define CAN_UNIT_1A_CMDID_TABLE_SIZE 2	// Cansender_1: Sensor board test

#define CAN_UNIT_1B_CMDID_TABLE_SIZE 1	// Cansender_2: Sensor board test

#define CAN_UNIT_1C_CMDID_TABLE_SIZE 1	// Sensor, engine: rpm, manifold pressure, throttle setting, temperature

#define CAN_UNIT_3_CMDID_TABLE_SIZE 1	// Logger_1

#define CAN_UNIT_E_CMDID_TABLE_SIZE 2	// Cable angle AD7799 #2 drum #1

#define CAN_UNIT_F_CMDID_TABLE_SIZE 2
...
{   3,  0xE8000000 }, /*   1 CAN_UNIT_11          CANID_CMD_TENSION_0	 Tension_a: 1 AD7799 VE POD Test (hence X) 0*/
};
#endif
...
{   4,  0x05E0000C }, /*   1 CAN_UNIT_12          CANID_CMD_TENSION_a21	 Tension_a2: 2 AD7799 VE POD Test (hence X) 1*/
{   3,  0x05C0000C }, /*   2 CAN_UNIT_12          CANID_CMD_TENSION_a11	 Tension_a:  2 AD7799 VE POD Test (hence X) 1*/
};
#endif
...
{  11,  0x29800000 }, /*   1 CAN_UNIT_13          CANID_CMD_YOGURT_1	 Yogurt_1: Ver 1 of maker      */
};
#endif
...
{   3,  0xF800004C }, /*   1 CAN_UNIT_14          CANID_CMD_TENSION_a1Y	 Tension_a:  1 AD7799 VE POD Test (hence X) 2*/
};
#endif
...
{   4,  0xF800006C }, /*   1 CAN_UNIT_15          CANID_CMD_TENSION_a22	 Tension_a2: 2 AD7799 VE POD Test (hence X) 3*/
{   3,  0xF800005C }, /*   2 CAN_UNIT_15          CANID_CMD_TENSION_a12	 Tension_a:  2 AD7799 VE POD Test (hence X) 3*/
};
#endif
...
{   4,  0xF800008C }, /*   1 CAN_UNIT_16          CANID_CMD_TENSION_a2G	 Tension_a2: 2 AD7799 VE POD GSM 1*/
{   3,  0xF800007C }, /*   2 CAN_UNIT_16          CANID_CMD_TENSION_a1G	 Tension_a:  2 AD7799 VE POD GSM 1*/
};
#endif
...
{  13,  0xD1C00064 }, /*   1 CAN_UNIT_1A          CANID_CMD_LOGGER_2	 Logger_2                      */
{  12,  0xD1C00074 }, /*   2 CAN_UNIT_1A          CANID_CMD_GPS_2	 GPS_2 time sync distribution msg */
};
#endif
...
// =====================================================================
#ifdef CAN_UNIT_1C	// a #define is used to select the following
const struct FUNC_CANID func_canid[] = {
{   0x04200000, CAN_UNIT_1C_CMDID_TABLE_SIZE },	/* {Unit CAN ID, Number of CAN IDs that follow} */
{  14,  0xA0400000 }, /*   1 CAN_UNIT_1C          CANID_CMD_CANSENDER_2	 Cansender_2: Sensor board test*/
};
#endif
...
{   2,  0x80600000 }, /*   1 CAN_UNIT_3           CANID_CMD_ENGINE_SENSOR	 Sensor, engine: rpm, manifold pressure, throttle setting, temperature*/
};
#endif
...
{  13,  0xD1C00054 }, /*   1 CAN_UNIT_E           CANID_CMD_LOGGER_1	 Logger_1                      */
{  12,  0xD1C00044 }, /*   2 CAN_UNIT_E           CANID_CMD_GPS_1	 GPS_1 time sync distribution msg*/
};
#endif
...
{   5,  0x06200000 }, /*   1 CAN_UNIT_F           CANID_CMD_CABLE_ANGLE_1	 Cable angle AD7799 #2 drum #1 */
{   3,  0x05C0003C }, /*   2 CAN_UNIT_F           CANID_CMD_TENSION_a1W	 Tension_a: Tension drum #1 AD7799 #1*/
};
#endif
